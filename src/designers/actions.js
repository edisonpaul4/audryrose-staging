...
export function saveVendorOrders(token, vendorOrders) {
    return {
        types: ['VENDOR_ORDERS_SAVE_REQUEST', 'VENDOR_ORDERS_SAVE_SUCCESS', 'VENDOR_ORDERS_SAVE_FAILURE'],
        promise: api.saveVendorOrders(token, vendorOrders)
    }
}
