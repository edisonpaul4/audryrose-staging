...
export const soldInStore = (token, variantId) => Parse.Cloud.run('soldInStore', 
    {
        sessionToken: token,
        variantId
    }
...
const deleteReturnResize = (returnId, token) => axios.post('/functions/deleteReturn', {
    sessionToken: token,
    returnId
});
...
const getDesignerStats = (token) => axios.post('/functions/getDesignerStats', {
    sessionToken: token
});
